...
app.use("/aulas", aula_1.default);
app.use("/profesores", profesor_1.default);
app.use("/estudiantes", estudiante_1.default);
app.use("/incidencias", incidencia_1.default);
app.use("/asistencias", asistencia_1.default);
