...
import { useUpdateAdminProfile } from "@/hooks/useAdmin";

type FormValues = z.infer<typeof perfilUsuarioSchema>;

export const PerfilAdminForm = () => {
  const navigate = useNavigate();
  const queryClient = useQueryClient();
  const { user } = useAuth()
  const updateMutation = useUpdateAdminProfile(user?.id || "");
    ...
    updateMutation.mutate(
      {
        ...
        data: {
          ...data,
          rol: "admin", // Mantenemos el rol actual
        },
      },
      {
        onSuccess: () => {
...
export default PerfilAdminForm;
