...
import { Aula, Estudiante, Incidencia } from "@/types";
...
export const IncidenciaForm: React.FC<IncidenciaFormProps> = ({
  ...
  const createMutation = useCreateIncidencia("admin");
  const updateMutation = useUpdateIncidencia("admin", initialData?.id || "");
